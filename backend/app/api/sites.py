...
async def edit_site(
    ...
    """
    Edits a site based on natural language instruction.
    """
    ...
    try:
        from app.services.ai_editing_service import AIEditingService
        editing_service = AIEditingService(db)
        result = await editing_service.apply_edit(order_id, instruction)
        return result
    except Exception as e:
